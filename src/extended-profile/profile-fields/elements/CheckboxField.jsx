...
const CheckboxField = (props) => {
	const {
		components: { EmptyContent, EditableItemHeader },
	} = useContext(ExtendedProfileFieldsContext);

	return (
		<BaseField
			{...props}
			renderEditingField={({ fieldName, fieldLabel, fieldError, draftValue, setDraftValue }) => (
				<>
					<Form.Checkbox
						id={fieldName}
						name={fieldName}
			...
			renderEditableField={({ fieldLabel, fieldName, handleStartEditing, draftValue }) => (
				<EditableItemHeader
					content={
