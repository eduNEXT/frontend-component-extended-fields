...
function _toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); } /* eslint-disable react/no-danger */
const CheckboxField = props => /*#__PURE__*/(0, _jsxRuntime.jsx)(_BaseField.default, _objectSpread(_objectSpread({}, props), {}, {
